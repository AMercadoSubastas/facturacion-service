...
class Kernel extends HttpKernel
{
     ...
     *
     * Estos middlewares se ejecutan para cada solicitud de la aplicación.
     *
     * @var array
     */
    protected $middleware = [
        ...
        \App\Http\Middleware\CorsMiddleware::class, // Middleware CORS personalizado (si aplica)
    ...
    protected $middlewareGroups = [
        ...
        'api' => [
            'throttle:api', // Control de la tasa de solicitudes API
            \Illuminate\Routing\Middleware\SubstituteBindings::class,
